...
<head>
  ...
  <!-- Bootstrap -->
  <link rel="stylesheet" href="{{asset('visitors_assets/plugins/bootstrap/bootstrap.min.css')}}">
  <link rel="stylesheet" href="{{asset('visitors_assets/plugins/themify/css/themify-icons.css')}}">
  <link rel="stylesheet" href="{{asset('visitors_assets/plugins/counto/animate.css')}}">
  <link rel="stylesheet" href="{{asset('visitors_assets/plugins/aos/aos.css')}}">
  <link rel="stylesheet" href="{{asset('visitors_assets/plugins/owl-carousel/owl.carousel.min.css')}}">
  <link rel="stylesheet" href="{{asset('visitors_assets/plugins/owl-carousel/owl.theme.default.min.css')}}">
  <link rel="stylesheet" href="{{asset('visitors_assets/plugins/magnific-popup/magnific-popup.css')}}">
  <link rel="stylesheet" href="{{asset('visitors_assets/plugins/animated-text/animated-text.css')}}">

  <!-- Main Stylesheet -->
  <link href="{{asset('visitors_assets/css/style.css')}}" rel="stylesheet">
...
<nav class="navbar navbar-expand-lg  main-nav " id="navbar">
	<div class="container">
	  <a class="navbar-brand" href="/">
	  	<img src="{{asset('visitors_assets/images/logo.png')}}" alt="" class="img-fluid">
	  </a>
		...
		<div class="row shuffle-wrapper portfolio-gallery">
	      <div class="col-lg-4 col-6 mb-4 shuffle-item"  data-groups="[&quot;design&quot;,&quot;illustration&quot;]">
		          ...
		          <div class="image position-relative ">
	               <img src="{{asset('visitors_assets/images/portfolio/1.jpg')}}" alt="portfolio-image" class="img-fluid w-100 d-block">
	      ...
	      <div class="col-lg-4 col-6 mb-4 shuffle-item" data-groups="[&quot;branding&quot;]">
	        <div class="position-relative inner-box" >
	            <div class="image position-relative ">
	               <img src="{{asset('visitors_assets/images/portfolio/4.jpg')}}" alt="portfolio-image" class="img-fluid w-100 d-block">
	                <div class="overlay-box">
	                  <div class="overlay-inner">
		                    <a class="overlay-content" href="portfolio-single.html">
	      ...
	      <div class="col-lg-4 col-6 mb-4 shuffle-item" data-groups="[&quot;illustration&quot;]">
	        <div class="position-relative inner-box">
	            <div class="image position-relative ">
	               <img src="{{asset('visitors_assets/images/portfolio/3.jpg')}}" alt="portfolio-image" class="img-fluid w-100 d-block">
	                <div class="overlay-box">
	                  <div class="overlay-inner">
	                    <a class="overlay-content" href="portfolio-single.html">
	      ...
	      <div class="col-lg-4 col-6 mb-4 shuffle-item" data-groups="[&quot;design&quot;,&quot;branding&quot;]">
	        <div class="position-relative inner-box">
	            <div class="image position-relative ">
	               <img src="{{asset('visitors_assets/images/portfolio/5.jpg')}}" alt="portfolio-image" class="img-fluid w-100 d-block">
	                <div class="overlay-box">
	                  <div class="overlay-inner">
	                    <a class="overlay-content" href="portfolio-single.html">
	      ...
	      <div class="col-lg-4 col-6 mb-4 shuffle-item" data-groups="[&quot;illustration&quot;]">
	        <div class="position-relative inner-box">
	            <div class="image position-relative ">
	               <img src="{{asset('visitors_assets/images/portfolio/6.jpg')}}" alt="portfolio-image" class="img-fluid w-100 d-block">
	                <div class="overlay-box">
	                  <div class="overlay-inner">
	                    <a class="overlay-content" href="portfolio-single.html">
	      ...
	      <div class="col-lg-4 col-6 mb-4 shuffle-item" data-groups="[&quot;design&quot;,&quot;photo&quot;]">
	        <div class="position-relative inner-box">
	            <div class="image position-relative ">
	               <img src="{{asset('visitors_assets/images/portfolio/7.jpg')}}" alt="portfolio-image" class="img-fluid w-100 d-block">
	                <div class="overlay-box">
	                  <div class="overlay-inner">
	                    <a class="overlay-content" href="portfolio-single.html">
...
<section class="footer">
	<div class="container">
		<div class="row ">
			<div class="col-lg-6">
				<p class="mb-0">Copyrights © 2019. Designed & Developed by <a href="/" class="text-white">Themefisher</a></p>
			</div>
			<div class="col-lg-6">
...
<!-- jQuery -->
<script src="{{asset('visitors_assets/plugins/jQuery/jquery.min.js')}}"></script>
<!-- Bootstrap JS -->
<script src="{{asset('visitors_assets/plugins/bootstrap/bootstrap.min.js')}}"></script>
<script src="{{asset('visitors_assets/plugins/aos/aos.js')}}"></script>
<script src="{{asset('visitors_assets/plugins/owl-carousel/owl.carousel.min.js')}}"></script>
<script src="{{asset('visitors_assets/plugins/shuffle/shuffle.min.js')}}"></script>
<script src="{{asset('visitors_assets/plugins/magnific-popup/jquery.magnific-popup.min.js')}}"></script>
<script src="{{asset('visitors_assets/plugins/animated-text/animated-text.js')}}"></script>
<script src="{{asset('visitors_assets/plugins/counto/apear.js')}}"></script>
<script src="{{asset('visitors_assets/plugins/counto/counTo.js')}}"></script>
